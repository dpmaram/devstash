---
name: feature
description: "Manage current feature workflow - load, start, test, review, explain, or complete features. Use when: user asks to load a feature, start working on a feature, test, review, explain, or complete a feature."
...
| `test` | Add or run tests for feature code |
