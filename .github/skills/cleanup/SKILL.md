---
name: cleanup
description: "Clean up project housekeeping tasks (add 'run' to execute fixes). Use when: user asks to clean up, check hygiene, find stale code, or run project housekeeping."
