...
CMD ["node", "server.js"]`,
  ...
  },
  {
    ...
    defaultTypeSlug: "command",
    isFavorite: false,
    items: [
      {
        id: "item_command_git_graph",
        title: "Compact Git Graph",
        description: "Inspect recent branch history with decorations.",
        typeSlug: "command",
        tags: ["git", "history", "branches"],
        isFavorite: true,
        content: "git log --oneline --graph --decorate --all -n 30",
      },
      {
        id: "item_command_docker_compose_rebuild",
        title: "Rebuild Docker Compose Stack",
        description: "Rebuild images and start services from the current compose file.",
        typeSlug: "command",
        tags: ["docker", "compose", "containers"],
        content: "docker compose up --build",
      },
      {
        id: "item_command_kill_port_3000",
        title: "Stop Process on Port 3000",
        description: "Find and terminate the process listening on the default Next.js port.",
        typeSlug: "command",
        tags: ["process", "ports", "nextjs"],
        content: "lsof -ti :3000 | xargs kill",
      },
      {
        id: "item_command_npm_audit_summary",
        title: "NPM Audit Summary",
        description: "Check dependency health without applying automatic fixes.",
        typeSlug: "command",
        tags: ["npm", "dependencies", "security"],
        content: "npm outdated && npm audit",
      },
    ],
  },
  {
    ...
    defaultTypeSlug: "link",
    isFavorite: false,
    items: [
      {
        id: "item_design_tailwind_docs",
        title: "Tailwind CSS Documentation",
        description: "Utility-first CSS framework documentation and reference.",
        typeSlug: "link",
        tags: ["css", "tailwind", "reference"],
        url: "https://tailwindcss.com/docs",
      },
      {
        id: "item_design_shadcn_docs",
        title: "shadcn/ui Documentation",
        description: "Accessible component patterns built on Radix and Tailwind CSS.",
        typeSlug: "link",
        tags: ["components", "react", "ui"],
        url: "https://ui.shadcn.com/docs",
      },
      {
        id: "item_design_atlassian_system",
        title: "Atlassian Design System",
        description: "Practical product design guidance for dense software interfaces.",
        typeSlug: "link",
        tags: ["design-system", "ux", "product"],
        url: "https://atlassian.design/",
      },
      {
        id: "item_design_lucide_icons",
        title: "Lucide Icons",
        description: "Open-source icon library used by the system item types.",
        typeSlug: "link",
        tags: ["icons", "lucide", "visual-design"],
